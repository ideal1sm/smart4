...
$this->addExternalCss(SITE_TEMPLATE_PATH . "/assets/styles/product.css");
$this->addExternalCss(SITE_TEMPLATE_PATH . "/assets/styles/product_responsive.css");
$this->addExternalJs(SITE_TEMPLATE_PATH . "/assets/js/product.js");
