                ...
                <div class="row">
                    <div class="col">
                        <div class="home_content">
                            <div class="home_title"><?= $arCurSection['NAME'] ?><span>.</span></div>
                            <?php if (!empty($arCurSection['DESCRIPTION'])): ?>
                                <div class="home_text"><p><?= $arCurSection['DESCRIPTION'] ?></p></div>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="sorting_bar d-flex flex-md-row flex-column align-items-md-center justify-content-md-start">
                    <div class="results">Найдено <span><?= $elemCnt ?></span> товаров</div>
